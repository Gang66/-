<template>
  <el-drawer size="70%" :with-header="true" class="tech_SupplierManagement_Components_StandardPriceComparison">
    <!-- <div class=" bg-gray-300 h-9"></div> -->
    <template v-slot:header
      ><span class="iconfont icon-shujuku inline-block"><i class="">标准比价</i></span>
    </template>
...
.tech_SupplierManagement_Components_StandardPriceComparison {
}
