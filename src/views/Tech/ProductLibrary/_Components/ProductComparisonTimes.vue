<template>
  <el-drawer size="70%" :with-header="true" custom-class="bf-drawer">
    ...
    <div class="w-96 h-10 mt-3 bg-green-100 rounded p-2 pl-6">
      <i class="iconfont icon-ok text-green-500 mr-2"></i>
      <div class="text-green-500 text-sm inline-block mr-4"><span class="">采购供应商：</span><span class="font-semibold">龙丰阀门</span></div>
      <div class="text-green-500 text-sm inline-block"><span class="">采购价格：</span><span class="font-semibold">￥1525.00</span></div>
    </div>
    ...
    <div class="table-wrapper">
      <table class="main-table" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td class="w-40 relative" v-for="item in 4">
            <div class="text-xs text-gray-400 text-center leading-7">
              <div class="absolute w-14 top-0 left-0">
                <img src="../../../../assets/img/tech/supplier.png" alt="" />
              </div>
        ...
        <tr>
          ...
          <td class="text-green-500" v-for="item in 4">
            <span class="ml-3 text-sm">111</span>
            <el-popover placement="bottom" :width="200" trigger="click">
              <template #reference>
        ...
        <tr>
          ...
          <td class="text-red-500" v-for="item in 4">
            <span class="ml-3 text-sm">111</span>
          </td>
        </tr>
        <tr>
          <td><span class="float-right mr-3 text-sm">最低（元）</span></td>
          <td class="text-teal-400" v-for="item in 4">
            <span class="ml-3 text-sm">111</span>
          </td>
        </tr>
        <tr>
