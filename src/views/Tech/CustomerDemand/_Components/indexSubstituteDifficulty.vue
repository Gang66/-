  ...
  <div class="w-full">
    ...
    <div class="inline-block w-880">
      <el-checkbox-group v-model="checkboxGroup1" size="small" @change="change">
        <el-checkbox border label="无">
          <div class="w-4 h-4 border border-yellow-500 rounded-t-none rounded-br-full rounded-bl-full inline-block text-center text-xs text-yellow-500 mr-1">
            <span>替</span>
          </div>
          <span>无</span>
        </el-checkbox>
        <el-checkbox border label="有">
          <div class="w-4 h-4 border border-yellow-500 rounded-t-none rounded-br-full rounded-bl-full inline-block text-center text-xs text-yellow-500 mr-1">
            <span>替</span>
          </div>
          <span>有</span>
        </el-checkbox>
        <el-checkbox border label="一般">
          <div class="w-4 h-4 border border-blue-400 rounded-t-none rounded-br-full rounded-bl-full inline-block text-center text-xs text-blue-400 mr-1">
            <span>技</span>
          </div>
          <span>一般</span>
        </el-checkbox>
        <el-checkbox border label="较难">
          <div class="w-4 h-4 border border-blue-400 rounded-t-none rounded-br-full rounded-bl-full inline-block text-center text-xs text-blue-400 mr-1">
            <span>技</span>
          </div>
          <span>较难</span>
