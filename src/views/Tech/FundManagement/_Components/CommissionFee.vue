    ...
    <div class="bf-table-content">
      <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="" label="成交金额" align="center">
          ...
          <el-table-column prop="Absenteeism" label="实际金额" align="center" width="90">
            <template #default="scope">
              <div class="text-sm">
                <span>153500</span>
                <!-- <span>-</span> -->
        ...
        <el-table-column prop="WorkAge" label="最低销售价" width="120" align="center">
          <template #default="scope">
            <span>810000</span>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="" label="提成分配" align="center">
          <el-table-column prop="" label="比例" align="center" width="90">
            <template #default="scope">
              <div class="text-sm">
                <span class="">1.5</span>
                <!-- <span>-</span> -->
          ...
          <el-table-column prop="Absenteeism" label="金额" align="center" width="90">
            <template #default="scope">
              <div class="text-sm">
                <span>1500</span>
                <!-- <span>-</span> -->
        ...
        <el-table-column prop="WorkAge" label="逾期减提" width="120" align="center">
          <template #default="scope">
            <span>1500</span>
            <!-- <span>-</span> -->
          </template>
