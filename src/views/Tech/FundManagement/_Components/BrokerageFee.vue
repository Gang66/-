  ...
  <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
    <div class="bf-table-content">
      <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="DepartName" label="居间人" width="100" align="center">
        ...
        <el-table-column prop="" label="合同金额" align="center" width="90">
          <template #default="scope">
            <div class="text-sm">
        ...
        <el-table-column prop="WorkAge" label="居间费" width="120" align="center">
          <template #default="scope">
            <span>1500</span>
          </template>
        </el-table-column>
        <el-table-column prop="WorkAge" label="申请费用" width="120" align="center">
          <template #default="scope">
            <span>1500</span>
          </template>
        </el-table-column>

        <el-table-column prop="" label="居间协议" align="center">
          <el-table-column prop="" label="协议" align="center" width="90">
            <template #default="scope">
              <div class="text-sm">
                <!-- <span class=" ">1.5</span> -->
                <span>-</span>
          ...
          <el-table-column prop="Absenteeism" label="举证" align="center" width="90">
            <template #default="scope">
              <div class="text-sm">
                <span class="text-gray-400">未上传</span>
                <!-- <span class="text-green-500">已上传</span> -->
              </div>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column prop="RecruitChannel" label="状态显示" align="center" width="80">
          <template #default="scope">
            ...
            <!-- <span class="text-red-500">财务驳回</span> -->
            <!-- <span class="text-orange-500">待发放</span> -->
            <!-- <span class="text-blue-500">合约确认</span> -->
          </template>
        </el-table-column>
      </el-table>
    </div>
