<template>
  ...
  <div class="ConsultationList-dow-query clearfix pb-1">
    ...
    <el-input v-model="form.NameInput" size="default" placeholder="客户名称" style="width: 240px" class="mr-4 ml-4" />
  ...
  <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
    <div class="bf-table-content">
      <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="" label="实际完成金额" align="center" width="140">
          <template #default="scope">
            <div class="text-sm">
        ...
        <el-table-column prop="WorkAge" label="目标业绩值" width="120" align="center">
          <template #default="scope">
            <span>15000</span>
          </template>
        </el-table-column>
        <el-table-column prop="WorkAge" label="合同金额" width="120" align="center">
          <template #default="scope">
            <span>157000.00</span>
          </template>
        </el-table-column>
        <el-table-column prop="WorkAge" label="逾期减提" width="90" align="center">
          <template #default="scope">
            <span>合同作废</span>
          </template>
        </el-table-column>
