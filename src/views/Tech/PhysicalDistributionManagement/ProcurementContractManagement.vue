        ...
        <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
          <div class="bf-table-content">
            <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="WorkAge" label="物流批次" width="80" align="center">
                <template #default="scope">
                  <!-- <span class="text-blue-500">2</span> -->
                  <span class="text-blue-500">新增</span>
                </template>
              </el-table-column>
              <el-table-column prop="WorkAge" label="发货清单" width="80" align="center">
                <template #default="scope">
                  <span class="text-blue-500">详见明细</span>
                  <!-- <span class="text-gray-400">暂无</span> -->
                </template>
              </el-table-column>
              <el-table-column prop="WorkAge" label="发货状态" width="80" align="center">
                <template #default="scope">
                  <!-- <span class="text-orange-400">已发货</span> -->
                  <!-- <span class="text-red-400">采购处理</span> -->
                  <span class="text-cyan-400">生产过程</span>
                </template>
              </el-table-column>
              <el-table-column prop="WorkAge" label="物流图集" align="center" width="80">
                <template #default="scope">
                  <span class="text-blue-600 cursor-pointer"><i class="iconfont icon-zitiyulan inline-block mr-1 text-blue-600"></i>查看</span>
                  <!-- <span class="text-gray-400">暂无</span> -->
                </template>
              </el-table-column>
              <el-table-column prop="WorkAge" label="预警列表" align="center" width="80">
                <template #default="scope">
                  <span class="text-blue-500">正常</span>
                </template>
              </el-table-column>
