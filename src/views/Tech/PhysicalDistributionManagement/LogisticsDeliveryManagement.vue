  ...
  <div class="Tec_ContractApproval">
    ...
    <div class="clearfix pt-3 pr-4 pb-3 pl-0 bg-gray-50 border-b border-gray-200 mb-0 rounded-t-md">
      <div class="float-left pt-1">
        <span class="ml-4 text-sm">物流发货管理</span>
      </div>
    </div>
            ...
            <el-table :data="data.tableData1" stripe @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="Name" label="客户名称" min-width="166" align="center">
                <template #default="scope">
                  <div class="inline-block">北京汀源环保科技发展有限公司</div>
                </template>
              </el-table-column>
              ...
              <el-table-column prop="WorkAge" label="交货期" align="center">
                <template #default="scope">2021-11-06</template>
              </el-table-column>
              ...
              <el-table-column prop="WorkAge" label="状态显示" align="center">
                <template #default="scope">
                  <!-- <span class="text-blue-500">采购处理</span> -->
                  <!-- <span class="text-red-500">生产过程</span> -->
                  <span class="text-green-500">已收货</span>
                </template>
              </el-table-column>
