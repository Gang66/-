<template>
  <div class="tech_technicalanalys">
    <div class="h-12">
      ...
      <div class="bf-table-content bg-white rounded-b-md mb-6">
        <!-- 搜索框 -->
        <div class="clearfix pt-2 pl-4 pr-4 mb-4">
        ...
        <div class="pt-0 pl-4 pr-4 pb-4">
          <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
            <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="InviteName" label="等级" width="120">
                <template #default="scope">
                  <!-- A -->
              ...
              <el-table-column prop="WorkAge" label="询价状态" width="120">
                <template #default="scope">跟进过程</template>
              </el-table-column>
              <el-table-column prop="PostName" label="审批状态" width="120" align="center">
                <template #default="scope">
                  <!-- 已通过 -->
                  <!-- <span class=" text-green-500 cursor-pointer" @click="openWindowAccountingRecords()">审批通过</span> -->
                  <!-- 待审核 -->
                  <span class="text-yellow-500 cursor-pointer" @click="openWindowAccountingRecords()">待审核</span>
                </template>
              </el-table-column>
            </el-table>
          </table-search>
...
import AccountingAnalysisTop from './_Components/TotalWages.vue'
import { Search } from '@element-plus/icons-vue'
import { parseTime } from '/@/utils/tools'
import TableSearch from '/@/components/TableSearch/index.vue'
import { GetPageList } from '/@/api/tech/EnquiryData'
import { accountingRecordsOpen } from '/@/assets/ts/techOpenWindow'
import AccountingRecords from './_Components/ApprovalStatus.vue'
