  ...
  <div class="Tec_ContractApproval">
    ...
    <div class="clearfix pt-1 pr-4 pb-1 pl-0 bg-gray-50 border-b border-gray-200 rounded-t-md">
      <div class="float-left pt-1">
        <span class="ml-4 text-sm">采购成本管理</span>
      </div>
    </div>
        ...
        <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
          <div class="bf-table-content">
            <el-table :data="data.tableData1" stripe @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="WorkAge" label="采购成本" width="160" align="center">
                <template #default="scope">
                  <div class="clearfix">
                    <span>380400000.00</span>
                    <!-- <span class="text-red-500 text-xs ml-2">1.80</span> -->
                    <span class="text-green-500 text-xs ml-2">2.01</span>
                  </div>
                </template>
              </el-table-column>
              <el-table-column prop="WorkAge" label="提成费" width="100" align="center">
                <template #default="scope">
                  <span>20</span>
                </template>
              </el-table-column>
              <el-table-column prop="WorkAge" label="物流费" width="80" align="center">
                <template #default="scope">
                  <span>20</span>
                </template>
              </el-table-column>
              ...
              <el-table-column prop="RecruitChannel" label="分项清单" align="center" width="80">
                <template #default="scope">
                  <div>
