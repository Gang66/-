  ...
  <div class="Tec_ContractApproval">
    ...
    <div class="clearfix pt-1 pr-4 pb-1 pl-0 bg-gray-50 border-b border-gray-200 rounded-t-md">
      <div class="float-left pt-1">
        <span class="ml-4 text-sm">销售报价库管理</span>
      </div>
    </div>
            ...
            <el-table :data="data.tableData1" stripe @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="Name" label="客户名称" min-width="166">
                <template #default="scope">
                  ...
                  <!-- 重 -->
                  <div class="customerName inline-block bg-blue-500 relative text-center mr-3 w-5 h-6">
                    <!-- v-if="scope.row.GradeCode === 'B'" -->
              ...
              <el-table-column prop="InviteName" label="状态" min-width="90" align="center">
                <template #default="scope">
                  <div>
                    ...
                    <span class="text-sm">跟进过程</span>
                  </div>
                  <!-- <div>
                    <div class="w-2 h-2 bg-green-500 rounded-full inline-block mr-2"></div>
                    <span class="text-sm">成单</span>
                  </div> -->
                  <!-- <div>
                    <div class="w-2 h-2 bg-yellow-500 rounded-full inline-block mr-2"></div>
                    <span class="text-sm">关闭跟进</span>
                  </div> -->
                  <!-- <div>
                    <div class="w-2 h-2 bg-gray-500 rounded-full inline-block mr-2"></div>
                    <span class="text-sm">失单</span>
                  </div> -->
                </template>
              </el-table-column>
