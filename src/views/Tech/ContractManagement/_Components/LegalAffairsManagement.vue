<template>
  <div class="tech_ContractApproval">
    ...
    <div class="bg-white relative">
      <!-- 搜索框 -->
      <div class="ConsultationList-dow-query pb-1">
        ...
        <div class="float-right mt-px">
          <el-button type="primary" class="ml-4">处理方案</el-button>
        </div>
      </div>
      <!-- 表格 -->
      <div class="pb-4">
          ...
          <div class="bf-table-content">
            <el-table :data="data.tableData1" stripe @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="CreateOn" label="生效时间" align="center" min-width="166">
                <template #default="scope">{{ scope.row.ConsultTime }}2022-08-23 14:05:14</template>
              </el-table-column>
              <el-table-column prop="Name" label="客户名称" min-width="240">
                <template #default="scope">
                  <div class="inline-block">{{ scope.row.ClientName }}甲天下（济南）文化传媒有限公司</div>
                </template>
              </el-table-column>
              ...
              <el-table-column prop="" label="付款方式" align="center">
                <el-table-column prop="" label="预付款" align="center" width="80">
                  <template #default="scope">
                    <div class="text-sm">
                      <span class="">850000</span>
                      <!-- <span>-</span> -->
                    </div>
                  </template>
                </el-table-column>
            ...
            <div class="zong h-10 clearfix text-center leading-10 border-b">
              <div class="w-500 h-10 float-left"><span class="text-sm">本表合计</span></div>
              <div class="sum1 h-10 float-left"><span class="text-sm">10000</span></div>
              <div class="sum3 h-10 float-left"><span class="text-sm">10000</span></div>
              <div class="sum2 h-10 float-left"><span class="text-sm">10000</span></div>
              <div class="sum2 h-10 float-left"><span class="text-sm">10000</span></div>
              <div class="sum2 h-10 float-left"><span class="text-sm">10000</span></div>
              <div class="sum2 h-10 float-left"><span class="text-sm">10000</span></div>
              <div class="sum1 h-10 float-left"><span class="text-sm">10000</span></div>
            ...
            <div class="zong h-10 clearfix text-center leading-10 border-b">
              <div class="w-500 h-10 float-left"><span class="text-sm">全表合计</span></div>
              <div class="sum1 h-10 float-left"><span class="text-sm">10000</span></div>
              <div class="sum3 h-10 float-left"><span class="text-sm">10000</span></div>
              <div class="sum2 h-10 float-left"><span class="text-sm">10000</span></div>
              <div class="sum2 h-10 float-left"><span class="text-sm">10000</span></div>
