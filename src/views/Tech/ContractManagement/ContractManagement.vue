  ...
  <div class="Tec_ContractApproval">
    ...
    <div class="clearfix pt-3 pr-4 pb-3 pl-0 bg-slate-200 rounded-t-md">
      <div class="float-left pt-1">
        <span class="ml-8 font-semibold">合约管理</span>
      </div>
    </div>
      ...
      <div class="pb-4">
        <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
          <div class="bf-table-content">
            <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange" show-summary>
              <el-table-column type="selection" width="50" align="center" />
              <el-table-column type="index" label="序号" width="54" align="center" />
              <el-table-column prop="CreateOn" label="合同时间" align="center" min-width="166">
              ...
              <el-table-column prop="WorkAge" label="已收金额" align="center" width="100">
                <template #default="scope">
                  <span class="text-sm">38000</span>
                </template>
              </el-table-column>
              <el-table-column prop="WorkAge" label="未收金额" align="center" width="100">
                <template #default="scope">
                  <span class="text-sm">-10001300</span>
                </template>
              </el-table-column>
          ...
          <div class="">
            <div class="w-500 h-12 bg-slate-50"></div>
          </div>
        </table-search>
      </div>
    </div>
