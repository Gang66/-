  ...
  <div class="Tec_ContractApproval">
    ...
    <div class="clearfix pt-1 pr-4 pb-1 pl-0 bg-gray-50 border-b border-gray-200 mb-0 rounded-t-md">
      <div class="float-left pt-1">
        <span class="ml-4 text-sm">采购比价管理</span>
      </div>
    </div>
        ...
        <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
          <div class="bf-table-content">
            <el-table :data="data.tableData" stripe>
              ...
              <el-table-column prop="WorkAge" label="分组数量" width="80" align="center">
                <template #default="scope">
                  <span class="text-green-400" v-if="scope.row.GroupConfirmCount == scope.row.GroupCount && scope.row.GroupCount > 0">{{ scope.row.GroupConfirmCount }} / {{ scope.row.GroupCount }}</span>
