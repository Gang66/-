    ...
    <div>
      <div class="p-4">
        ...
        <div class="pt-3">
          ...
          <el-button type="primary" @click="openWindowAdjustGrouping()"> <i class="iconfont icon-chanpin mr-2"></i> 调整分组</el-button>
          ...
          <el-button type="primary"> <i class="iconfont icon-zitiyulan mr-2"></i> 查看合同</el-button>
        </div>
        <div class="bf-table-content">
          <el-table :data="data.PurchaseList" stripe @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="CreateOn" label="技术参数" width="340" v-if="data.FromsParam == 1">
              <template #default="scope">
                <div class="inline-block">
                  <p class="text-sm mb-2 mt-2">304浆料闸板阀 PZ73F-10P DN200</p>
                  <p class="text-xs">304; 304</p>
                </div>
                <div class="w-16 h-7 leading-6 bg-green-100 border-green-300 border-dashed border-2 text-sm text-center transform rotate-12 absolute right-2 top-5 opacity-95 rounded text-green-500">已确认</div>
                <!-- <div class="w-16 h-7 leading-6 bg-red-100 border-red-300 border-dashed border-2 text-sm text-center transform rotate-12 absolute right-2 top-5 opacity-95 rounded text-red-500">待核准</div> -->
              </template>
            </el-table-column>
            ...
            <el-table-column prop="CreateOn" label="核采价格" align="center">
              <template #default="scope">
            ...
            <el-table-column prop="CreateOn" label="供应商" align="center" width="120">
              <template #default="scope">
                <span>麦斯凯阀门</span>
              </template>
            </el-table-column>
      ...
      <!-- 调整分组 -->
      <AdjustGrouping title="管理分组" v-if="adjustGroupingOpenData.visible" :FormData="adjustGroupingOpenData.formData" @closeWindow="closeWindowAdjustGrouping($event)" />
    </div>
  </OpenWindow>
</template>
...
import AdjustGrouping from './AdjustGrouping.vue'
