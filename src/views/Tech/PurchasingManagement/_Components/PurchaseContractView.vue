        ...
        <div id="page-content">
          <div style="font-family: Arial,SimSun,STSong,serif!important;" class="content-wai">
            <div  style="margin: 0 80px;">
              ...
              <div style="font-size: 22px; text-align: center;" class="font-bold">设备订货合同书</div>
              <div class="flex justify-between">
                <div class="font-bold">
                  <p>购货方（甲方）：{{ prop.FormData.CompanyName || '' }}</p>
                  <p>供货方（乙方）：{{ prop.FormData.Y_CompanyName || '' }}</p>
                  <p>签定时间：{{ prop.FormData.AgreeDate || '' }}</p>
                </div>
                <div class="font-bold">
                  <p>合同地点：{{ prop.FormData.BillNo || '系统保存生成' }}</p>
              ...
              <template v-if="prop.formattype==0||prop.formattype==2">
                ...
                <table class="table mb-5">
                  ...
                  <tr v-if="prop.FormData.DiscountAmount>0">
                    <td>优惠金额</td>
                    <td :colspan="prop.ColumnData2.length - 2">大写：{{toChies(prop.FormData.DiscountAmount)}}</td>
                    <td colspan="2">￥{{prop.FormData.DiscountAmount}}</td>
                  </tr>
                </table>
                <!-- <table class="table">
                  <tr>
              ...
              <div v-html="prop.ContractTerms" class="mb-5"></div>

              <table class="table-other" border="1" cellpadding="0" cellspacing="0">
                <tr>
                  <td>甲方</td>
                  <td>乙方</td>
                </tr>
