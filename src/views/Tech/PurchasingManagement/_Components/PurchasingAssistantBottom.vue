<template>
  <el-row :gutter="20" class="pb-6">
    ...
    <el-col :span="12">
      <div class="clearfix pt-2 pr-4 pb-2 pl-0 bg-white border-b mt-3 rounded-t-md">
        <div class="float-left pt-1">
          <span class="ml-4 text-base">合同统计</span>
      ...
      <div class="flex bg-white rounded-b-md">
        <div class="w-1/3 bg-white rounded-b-md">
          <div class="p-4 pl-8">
            <p class="text-sm text-gray-400">逾期金额/合同量</p>
        ...
        <div class="w-1/3 bg-white">
          <div class="p-4 pl-8">
            <p class="text-sm text-gray-400">录入量/报价量</p>
        ...
        <div class="w-1/3 bg-white rounded-b-md">
          <div class="p-4 pl-8">
            <p class="text-sm text-gray-400">投诉量/占比</p>
            <p class="text-2xl">8 <span class="text-sm">次</span> / 31.5 <span class="text-sm">%</span></p>
            <p class="text-xs text-green-500"><span class="text-gray-400">较昨日</span> 15.9% <i class="iconfont icon-upall"></i></p>
          </div>
        </div>
      </div>
    ...
    <el-col :span="12">
      <div class="clearfix pt-2 pr-4 pb-2 pl-0 bg-white border-b mt-3 rounded-t-md">
        <div class="float-left pt-1">
          <span class="ml-4 text-base">订单统计</span>
          <span class="text-xs ml-3 text-gray-400">最近更新时间：2022-06-18 10:16</span>
        </div>
      </div>
      <div class="flex bg-white rounded-b-md">
        ...
        <div class="w-1/4 bg-white">
          <div class="p-4 pl-8">
            <p class="text-sm text-gray-400">生产中</p>
            <p class="text-sm"><span class="text-2xl font-semibold">16</span>单</p>
            <p class="text-xs text-green-500"><span class="text-gray-400">较昨日</span> 15.9% <i class="iconfont icon-upall"></i></p>
          </div>
        </div>
        <div class="w-px h-16 bg-gray-200 mt-4"></div>
        <div class="w-1/4 bg-white">
          <div class="p-4 pl-8">
            <p class="text-sm text-gray-400">生产完成</p>
            <p class="text-sm"><span class="text-2xl font-semibold">7</span>单</p>
            <p class="text-xs text-green-500"><span class="text-gray-400">较昨日</span> 15.9% <i class="iconfont icon-upall"></i></p>
          </div>
        </div>
        <div class="w-px h-16 bg-gray-200 mt-4"></div>
        <div class="w-1/4 bg-white rounded-b-md">
          <div class="p-4 pl-8">
            <p class="text-sm text-gray-400">未发货</p>
            <p class="text-sm"><span class="text-2xl font-semibold">5</span>单</p>
            <p class="text-xs text-green-500"><span class="text-gray-400">较昨日</span> 15.9% <i class="iconfont icon-upall"></i></p>
          </div>
        </div>
        <div class="w-px h-16 bg-gray-200 mt-4"></div>
        <div class="w-1/4 bg-white rounded-b-md">
          <div class="p-4 pl-8">
            <p class="text-sm text-gray-400">预警中</p>
            <p class="text-sm"><span class="text-2xl font-semibold">3</span>单</p>
            <p class="text-xs text-green-500"><span class="text-gray-400">较昨日</span> 15.9% <i class="iconfont icon-upall"></i></p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-b-md">
        ...
        <div class="flex pt-6 pb-8">
          <div>
            ...
            <div class="float-left inline-block ml-6 text-sm">
              <p class="text-gray-400 text-sm"><span class="text-base font-semibold text-black"> 232 </span>个</p>
              <p class="text-gray-400 text-xs">常用 <span class="font-semibold text-gray-500">226 </span> 非常用 <span class="text-gray-500 font-semibold">226 </span></p>
            </div>
          </div>
          <div class="ml-20">
