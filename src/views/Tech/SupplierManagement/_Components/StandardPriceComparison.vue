<template>
  <el-drawer size="70%" :with-header="true" custom-class="bf-drawer">
    ...
    <div class="ml-6 mr-6 mt-4 tech_supplierManagement_standardPriceComparison">
      ...
      <div class="table-wrapper">
        <table class="main-table" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="w-20" v-for="item in 5">
              <div class="text-xs text-gray-400 text-center leading-7">
                <p class="text-black text-lg">治泰阀门</p>
                <p>2021-09-06 14:49</p>
                <p>永嘉冶泰阀门制造有限公司</p>
                <el-popover placement="bottom" :width="200" trigger="click" popper-class="my-popover">
                  <template #reference>
                    <el-button style="width: 200px" type="primary" plain>换时间</el-button>
                  </template>
                  <div>
                    <div class="h-10 bg-slate-50 leading-10 pl-3">
                      <p class="text-blue-500">供应商 > <span class="font-semibold text-black">时间</span></p>
                    </div>
                    <div v-for="(item, index) in 4">
                      <div class="h-9 bg-blue-50 leading-9 pl-3">2022年</div>
                      <div class="text-xs cursor-pointer">
                        <div v-for="(item, index) in 4" @click="changeTimeClick(index)" class="leading-6 h-8 pl-3 pr-3">
                          <span>2022-06-12 15:22</span>
                          <span class="text-red-500 float-right">1615.00</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <tr>
            ...
            <td class="text-blue-500"><span class="ml-3 text-sm">111</span></td>
            <td class="text-blue-500"><span class="ml-3 text-sm">111</span></td>
            <td class="text-blue-500"><span class="ml-3 text-sm">111</span></td>
            <td class="text-blue-500"><span class="ml-3 text-sm">111</span></td>
            <td class="text-blue-500"><span class="ml-3 text-sm">111</span></td>
          ...
          <tr>
            <td><span class="float-right mr-3 text-sm">采购价（元）</span></td>
            <td v-for="item in 5" class="text-green-500 text-sm">
          ...
          <tr>
            ...
            <td class="text-cyan-500"><span class="ml-3 text-sm">111</span></td>
            <td class="text-cyan-500"><span class="ml-3 text-sm">111</span></td>
            <td class="text-cyan-500"><span class="ml-3 text-sm">111</span></td>
            <td class="text-cyan-500"><span class="ml-3 text-sm">111</span></td>
            <td class="text-cyan-500"><span class="ml-3 text-sm">111</span></td>
        ...
        <table class="main-table" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td v-for="item in 5"><span class="ml-3 text-sm">111</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td v-for="item in 5"><span class="ml-3 text-sm">12</span></td>
          </tr>
          <tr>
            <td class="w-52">
...
export default defineComponent({
  setup() {
    ...
    // 换时间
    const changeTimeClick = (index: number) => {
      console.log(index)
    }
