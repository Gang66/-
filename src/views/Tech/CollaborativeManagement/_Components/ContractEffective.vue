<template>
  ...
  <div class="ConsultationList-dow-query clearfix pb-1">
    ...
    <div class="float-right mt-px">
      <el-button type="primary"> <i class="iconfont icon-hetong mr-2"></i> 新建合同</el-button>
      <el-button type="warning"><i class="iconfont icon-dingdan9 mr-2"></i>提报审批</el-button>
      <el-button type="info"><i class="iconfont icon-shanchu mr-2"></i>作废合同</el-button>
    </div>
  </div>
  <!-- #region  表格-->
  <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
    <div class="bf-table-content">
      <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="WorkAge" label="合同状态" width="120" align="center">
          <template #default="scope">
            <span class="text-gray-400">待生效</span>
            <!-- <span class="text-blue-500">领导审批</span> -->
            <!-- <span class="text-red-500">等待盖章</span> -->
          </template>
        </el-table-column>
        <el-table-column prop="WorkAge" label="审批状态" width="140" align="center">
          <template #default="scope">
            <!-- <span class="text-gray-400">未提报</span> -->
            <span class="text-orange-400">总经理审批</span>
            <!-- <span class="text-green-400">备货通过</span> -->
            <!-- <span class="text-green-400">审批通过</span> -->
            <!-- <span class="text-orange-400">销售审批</span> -->
            <!-- <span class="text-orange-400">运营审批</span> -->
          </template>
        </el-table-column>
        ...
        <el-table-column prop="WorkAge" label="操作" width="140" align="center">
          <template #default="scope">
            <!-- <div>
              <i class="iconfont icon-zitiyulan inline-block mr-1 text-blue-600"></i>
              <div class="text-blue-600 inline-block cursor-pointer">查看</div>
