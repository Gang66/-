<template>
  ...
  <div class="ConsultationList-dow-query inline-block pb-1">
    ...
    <el-select v-model="form.StatusId" placeholder="审批状态" style="width: 120px" class="mr-4">
  ...
  <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
    <div class="bf-table-content">
      <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="WorkAge" label="供货周期" width="120" align="center">
          <template #default="scope">
            <span>20</span>
          </template>
        </el-table-column>
        <el-table-column prop="WorkAge" label="审批状态" width="120" align="center">
          <template #default="scope">
            <span class="text-gray-400">合同作废</span>
          </template>
        </el-table-column>
