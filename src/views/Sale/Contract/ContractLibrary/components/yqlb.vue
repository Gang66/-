    ...
    <div class='h-350 flex flex-col bg-white rounded border-blue-300 h-full p-1 ranking'>
        <div class='rounded border-blue-300 h-full w-full overflow-hidden'>
            ...
            <el-table :data='dataInfo.list' style='width: 100%;height: 290px' :fit='false' :header-cell-style='dataInfo.table_header'>
                ...
                <el-table-column prop='name' :label='dataInfo.frist_name' align='center' :width='81'>
                    <template #default='scope'>
                        <span 
                ...
                <el-table-column prop='people' :label='dataInfo.second_name' align='center' :width='75'>
                    <template #default='scope'>
                ...
                <el-table-column prop='ywy_num' label='逾期合同量' align='center' :width='74' />
                <el-table-column prop='ywy_num' label='逾期总额' align='center' :width='74' />
                <el-table-column prop='ywy_num' label='逾期占比' align='center' :width='74' />
            </el-table> 
        </div>
    </div>
</template>
