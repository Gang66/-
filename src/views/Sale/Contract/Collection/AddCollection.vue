          ...
          <el-form ref='ruleFormRef' :model='data' :rules="rules" :inline='true'>
            ...
            <el-card class='sale_card mt-2'>
              ...
              <div class="flex justify-between">
                ...
                <div v-if="ViewType==1">
                  <el-button size="small" type="primary" @click="addentity">
                    <el-icon-plus class='w-4 h-4' />新增收款
                  </el-button>
...
import { PostAddCollection, GetCollectionInfo, GetContractCollection } from '/@/api/Sale/Receivable'
