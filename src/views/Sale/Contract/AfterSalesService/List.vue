<template>
  <div>
        ...
        <div class='salerDialog'>
          <el-card class='sale_card'>
            ...
            <div v-if="data.tableTop==0">
              <el-table border :data='data.AfterSaleList'
            ...
            <div v-if="data.tableTop==1">
              <el-table border :data='data.ReturnList'
                :header-cell-style="{'font-size': '12px',padding:'0px' ,background: '#E7F4FE', color: '#303133',height:'36px', textAlign:'center',fontWeight:'500' }"
                :cell-style="{ textAlign: 'center',color: '#333',height:'36px',padding:'0px' }" style='width: 100%'>
                <el-table-column type="index" width='60' label='序号'>
                </el-table-column>
            ...
            <div v-if="data.tableTop==2">
              <el-table border :data='data.InvoicingList'
                :header-cell-style="{'font-size': '12px',padding:'0px' ,background: '#E7F4FE', color: '#303133',height:'36px', textAlign:'center',fontWeight:'500' }"
                :cell-style="{ textAlign: 'center',color: '#333',height:'36px',padding:'0px' }" style='width: 100%'>
                <el-table-column type="index" width='60' label='序号'>
                </el-table-column>
            ...
            <div v-if="data.tableTop==3">
              <el-table border :data='data.CollectionList'
                :header-cell-style="{'font-size': '12px',padding:'0px' ,background: '#E7F4FE', color: '#303133',height:'36px', textAlign:'center',fontWeight:'500' }"
                :cell-style="{ textAlign: 'center',color: '#333',height:'36px',padding:'0px' }" style='width: 100%'>
                <el-table-column type="index" width='60' label='序号'>
                </el-table-column>
    ...
    <AfterSales :title="'售后申请'" v-if="ShowAfterSales.show" :ContractId='ShowAfterSales.contractid' :ViewType='ShowAfterSales.viewtype' :DataId='ShowAfterSales.dataId'
      @cancelContract="cancelAfterSales"></AfterSales>

    <ReturnProducts :title="'退货申请'" v-if="Showreturnproducts.show" :ContractId='Showreturnproducts.contractid' :ViewType='Showreturnproducts.viewtype'
      :DataId='Showreturnproducts.dataId' @cancelContract="cancelreturnproducts">
    </ReturnProducts>

    <Invoicing :title="'开票申请'" v-if="ShowInvoicing.show" :ViewType='ShowInvoicing.viewtype' :ContractId='ShowInvoicing.contractid' :DataId='ShowInvoicing.dataId'
      @cancelContract="cancelInvoicing">
    </Invoicing>

    <AddCollection :title="'新增收款'" v-if="ShowCollection.show" :ViewType='ShowCollection.viewtype' :ContractId='ShowCollection.contractid' :DataId='ShowCollection.dataId'
      @cancelContract="cancelCollection">
    </AddCollection>
  </div>
</template>
...
import { GetAfterSalesList, GetReturnProductseList, GetInvoicingList } from '/@/api/Sale/AfterSale'
