<template>
  <div class="giftlist">
    <!-- 柱状图 -->
    <EchartsMsg :MsgType="1" v-if="EchartsShow"></EchartsMsg>
    ...
    <div class="">
      <el-table :data='data.tableData' @selection-change="handleSelectionChange"
        ...
        <el-table-column label='礼品数量' width="200">
...
import Add from './AddGift.vue'
import EchartsMsg from '/@/views/Sale/Cost/Entertainment/EchartsMsg.vue'
import { GetCostGiftList } from '/@/api/Sale/Cost'
