<template>
  <div>
    ...
    <AddCompetitor v-if='data.AddCompetitor.view' :DataId="data.AddCompetitor.dataid" :ViewType="data.AddCompetitor.viewtype" :CustomerId='data.AddCompetitor.customerid'
      :CustomerName='data.AddCompetitor.cusname' :title='data.AddCompetitor.title' @closeWindow='closeCompetitor' />
  </div>
</template>
<script lang="ts" setup>
import AddCompetitor from './AddCompetitor.vue'
import { GetCompeteList } from '/@/api/Sale/Customer'
