                  ...
                  <div class="flex justify-between">
                    <div>
                      <div class="flex pt-2 pl-4">
                        <div v-for='(item,i) in Problems' :key='i' class=" headerbut  cursor-pointer"
...
import { GetCusCommunicateInfo, GetCusCommunicateList, GetUpdateCommunicateState, PostAddCustomerCommunicate, PostAddCusCommunicateEntity } from '/@/api/Sale/Customer'
