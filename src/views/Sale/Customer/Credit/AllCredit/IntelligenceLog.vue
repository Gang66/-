<template>
  <div>
    ...
    <IntelligenceMsg v-if='data.AddCommunicate.view' :ViewType="data.AddCommunicate.viewtype" :DataId='data.AddCommunicate.dataid' :CustomerName='data.AddCommunicate.CusName'
...
import { GetCusCommunicateList } from '/@/api/Sale/Customer'
