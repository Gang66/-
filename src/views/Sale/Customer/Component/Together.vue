  ...
  <div>
    <CusDialog :box-style='boxStyle' :title='title' :is-show='true' @closeWindow='closeWindow'>
      ...
      <div v-if="ViewType==4" class="text-center pt-6">
        <el-button class="cancelbut" @click="Appchange(-2)">
          拒绝
        </el-button>
        <el-button type="primary" @click="Appchange(100)">
          同意
        </el-button>
      </div>
    </CusDialog>
...
import { GetSaleCompUserList, PostAddCustomerTogether, GetChangeRecordById, GetAppCustomerTogther } from '/@/api/Sale/Customer'
