<template>
  <CusDialog :boxStyle='boxStyle' :dialog-visible='dialogVisible' :title='data.form.CustomerName+"的沟通"' @closeWindow='closeWindow'>
            ...
            <div class='card-header'>
              ...
              <div class='header-right '>
                <div class="flex justify-end">
                  <el-button v-if="conviewType!=5" @click="showmessage" size="small">
                    历史记录
