        ...
        <div v-if="form.Type=='居间人'">
          ...
          <el-card class='sale_card mt-2'>
            ...
            <div class="el-card__body ">
              <el-table border :data='form.SituationData'
                ...
                <el-table-column prop='CreatrOn' label='授权品牌'>
                </el-table-column>
...
import { GetSentimentList, GetSituationInfo, GetCustomerProblems, PostAddOrEditSituationInfo } from '/@/api/Sale/Customer'
