  ...
  <div class="otherlist">
    ...
    <div class="flex items-center justify-between mb-2">
      ...
      <div class="flex items-center">
        ...
        <el-button class="addbutclass" :icon="Plus" @click="Addreturnproducts">退货录入</el-button>
      </div>
    </div>
    <!-- 列表部分 -->
    <div class="">
    ...
    <ReturnProducts :title="'退货申请'" v-if="Showreturnproducts.show" :ContractId='0' :ViewType='Showreturnproducts.viewtype'
      :DataId='Showreturnproducts.dataId' @cancelContract="cancelreturnproducts">
    </ReturnProducts>
  </div>
</template>
<script lang="ts" setup>
import { GetReturnProductseList } from '/@/api/Sale/AfterSale'
import { reactive, ref, onMounted, getCurrentInstance } from 'vue'
import { Plus } from '@element-plus/icons-vue'
import { ElMessage } from 'element-plus'
// 组件
import ReturnProducts from '../Contract/AfterSalesService/ReturnProducts.vue'
...
const Addreturnproducts = () => {
  Showreturnproducts.viewtype = 1
  Showreturnproducts.dataId = 0
  Showreturnproducts.show = true
}

const Viewreturnproducts = (val: any) => {
  Showreturnproducts.viewtype = 2
