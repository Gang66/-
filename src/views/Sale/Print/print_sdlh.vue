          ...
          <div>
            <div class="pb-1" style="    border-bottom: 2px solid #333;">
              <div class="flex pb-4 justify-between" style="    border-bottom: 2px solid #333;">
                <div class="w-40">
                  <img src="/src/assets/img/sale/order/logo-lianhe.jpg" alt="" />
                </div>
                <div class="pl-4 ">
                ...
                <div class="pl-4" style="text-align: center;">
                  <div class="text-2xl p-2" style="    border-bottom: 2px solid #333;">报价单</div>
                  <div class="text-base">QUOTATION SHEET</div>
                </div>
              </div>
            </div>
            <div class="flex justify-between text-sm px-12 py-4">
              <div class="w-1/2">
                <div> <span class="font-bold">收件人(TO)：</span>{{ printdata.data.CustomerConName }}</div>
                <div><span class="font-bold">收件单位：</span>{{ printdata.data.CustomerName  }}</div>
                <div><span class="font-bold">电话/传真：</span>{{  printdata.data.CC_Telephone}}</div>
              </div>
              <div class="w-1/2">
                <div> <span class="font-bold">发件人(FORM)：</span>{{ printdata.data.SalerName }}</div>
                <div><span class="font-bold">发件单位：</span>{{ data.OrderCompany.Rename }}</div>
                <div><span class="font-bold">电话/传真：</span>{{ printdata.data.S_Telephone}}</div>
              </div>
            </div>
