      ...
      <div class="bf-window-padding">
        <div id="printMe">
          <div style="    border: 1px solid #333;">
            <div class="p-4">
              <div class="pb-1 " style="    border-bottom: 2px solid #333;">
                <div class="flex pb-4 justify-between" style="    border-bottom: 2px solid #333;">
                  <div class="w-40">
                    <img src="/src/assets/img/sale/order/logo-gzy.png" alt="" />
                  </div>
                  <div class="pl-4 ">
                    <h1 class="text-xl font-bold">{{data.OrderCompany.Rename}}</h1>
                    <div class="text-sm">
            ...
            <div class="flex justify-between text-sm  p-4 ">
              <div class="w-1/2 pr-2 ">
                <div class="pl-8" style="    border-bottom: 1px solid #333;"> <span class="font-bold">收件人(TO)：</span>{{ printdata.data.CustomerConName }}</div>
                <div class="pl-8" style="    border-bottom: 1px solid #333;"><span class="font-bold">收件单位：</span>{{ printdata.data.CustomerName  }}</div>
                <div class="pl-8" style="    border-bottom: 1px solid #333;"><span class="font-bold">电话/传真：</span>{{  printdata.data.CC_Telephone}}</div>
              </div>
              <div class="w-1/2 ">
                <div class="pl-8" style="    border-bottom: 1px solid #333;"> <span class="font-bold">发件人(FORM)：</span>{{ printdata.data.SalerName }}</div>
                <div class="pl-8" style="    border-bottom: 1px solid #333;"><span class="font-bold">发件单位：</span>{{ data.OrderCompany.Rename }}</div>
                <div class="pl-8" style="    border-bottom: 1px solid #333;"><span class="font-bold">电话/传真：</span>{{ printdata.data.S_Telephone}}</div>
              </div>
            </div>

            <div class="text-xl pl-2">
              以下为贵公司报价产品明细，请详阅：如有疑问，请及时与我司联系，谢谢！
            </div>
