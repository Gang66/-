...
const sumnumber = () => {
  console.log('(props.printdata.data.Amount', props.printdata.data.Amount)
  console.log('toChies(props.printdata.data.Amount)111', toChies(Number(props.printdata.data.Amount)))
