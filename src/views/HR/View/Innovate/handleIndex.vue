<template>
  <div class="bf-content">
      ...
      <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false"
        ...
        <el-form :model="form" label-width="70px" class="bf-search-formItem">
          <div class="flex justify-between items-center">
            <div class="bf-table-label">创新分配</div>
        ...
        <div class="bf-table-content">
          <el-table :data="data.tableData" class="w-full">
            ...
            <el-table-column label="操作" align="center">
              <template #default="scope">
                <el-button text key="primary" type="primary" @click="openWindow(true, scope.row.Id,false)">详情</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
    ...
    <!-- 创新举措表单 -->
    <InnovateForm title="创新举措" v-if="data.indexWindow.show" :isHandle="data.indexWindow.isHandle" :isEdit="data.indexWindow.isEdit" @closeWindow="closeWindow"
      :Id="data.indexWindow.Id"></InnovateForm>
  </div>
</template>
