<template>
  <el-upload ref="uploadRef" action multiple :auto-upload="true" :disabled="data.isView" list-type="picture-card" :on-preview="handlePictureCardPreview" :on-remove="handleRemove" :on-change="handleChange" :file-list="fileList" :http-request="submitUpload">
    <el-icon :size="60">
      <el-icon-Camera />
    </el-icon>
  </el-upload>
