  ...
  <div class="AssetManagement-AssetProcurement-Components-purchaseForm">
    ...
    <table-search :current-page="form.page" :page-size="form.size" :total="form.totals" @size-change="handleSizeChange" :isAdvancedSearch="false" @current-change="handleCurrentChange">
      <div class="bf-table-content">
        <el-table ref="multipleTableRef" :data="data.managementList">
          ...
          <el-table-column min-width="80" prop="name" label="性别" align="center">
            <template #default="scope">
          ...
          <el-table-column prop="model" label="专业" min-width="70">
            <span>本科</span>
          </el-table-column>
          <el-table-column prop="people" label="籍贯" min-width="100" align="center">
            <span>山东潍坊</span>
          </el-table-column>
          <el-table-column min-width="120" align="center">
            <template #header>
              <div>员工档案 <i class="iconfont icon-shaixuan align-middle"></i></div>
            </template>
            <template #default="{ row }">
              <!-- <div>
                <div class="w-2 h-2 inline-block rounded-full bg-orange-400"></div>
                <span class="ml-2">完善信息</span>
              </div> -->
              <!-- <div >
                <div class="w-2 h-2 inline-block rounded-full bg-gray-400"></div>
                <span class="ml-2">已生效</span>
              </div> -->
              <div>
                <div class="w-2 h-2 inline-block rounded-full bg-blue-400"></div>
                <span class="ml-2">待确认</span>
              </div>
            </template>
          </el-table-column>
          <el-table-column min-width="100" align="center">
            <template #header>
              <div>档案状态 <i class="iconfont icon-shaixuan align-middle"></i></div>
            </template>
            <template #default="{ row, $index }">
              <!-- <el-button link type="primary"><span class="text-blue-500">上传照片</span></el-button> -->
              <el-button link type="primary">
                <p class="text-black">倒计时 <span class="text-orange-400">4</span> 天</p>
              </el-button>
            </template>
          </el-table-column>
        </el-table>
