<template>
  <div>
    <OpenWindow title="课件上传" :isShow="true" :boxStyle="data.boxStyle" @closeWindow="closeuploadnWindow">
      <div class="p-4">
        <uploads @uploadFileData="uploadFileData($event)" :uploadFileList="uploadData.FilePathList" />
        <div class="flex justify-center mt-4">
          <el-button size="large" @click="closeuploadnWindow">取消</el-button>
