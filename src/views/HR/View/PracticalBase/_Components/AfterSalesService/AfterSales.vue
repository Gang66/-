          ...
          <el-form ref="ruleFormRef" :model="data.form" :rules="rules" :inline="true">
            <el-card class="sale_card">
              ...
              <el-form-item label="备注" prop="Note">
                <el-input v-model="data.form.Note" :readonly="data.disabled" :autosize="{ minRows: 1, maxRows: 10 }" type="textarea" placeholder="请输入" style="width: 893px" />
              </el-form-item>
            </el-card>
            <el-card class="sale_card mt-2">
              ...
              <el-form-item label="问题描述" prop="Remark">
                <el-input v-model="data.form.Remark" :readonly="data.disabled" :autosize="{ minRows: 1, maxRows: 10 }" type="textarea" placeholder="请输入" style="width: 893px" />
              </el-form-item>
              <div class="flex pt-8">
...
import { PostAddAfterSalesInfo, GetAfterSalesById } from '/@/api/hr/School/AfterSale'
import { GetContractBillInfo } from '/@/api/hr/School/PracticalBase'
