<template>
  <hot-table :settings="hotSettings" :colHeaders="data.colHeaders" minRows="30" :rowHeights="data.rowheight" :columns="data.columns" :width="data.width" ref="hotTableComponent"> </hot-table>
</template>
