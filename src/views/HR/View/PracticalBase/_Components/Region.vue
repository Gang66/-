<template>
  <div>
    <CusDialog :box-style="data.ViewType != 1 ? boxStyle : boxStyle2" :title="title" :is-show="true" @closeWindow="closeWindow">
          ...
          <el-form ref="ruleFormRef" :model="data.form" :rules="rules" :inline="true">
            <el-card class="sale_card">
              ...
              <el-form-item label="公司地址" prop="Company">
                <el-cascader :disabled="data.disabled" :placeholder="Region == null ? '加载中' : '请选择地址'" :options="Region" :props="regionProps" filterable v-model="data.form.CityAddress" style="width: 333px"></el-cascader>
              </el-form-item>
...
import { GetRegionTreeByUserId, PostApprovalRegional, GetRegionalInfo, PostAddRegional } from '/@/api/hr/School/PracticalBase'
