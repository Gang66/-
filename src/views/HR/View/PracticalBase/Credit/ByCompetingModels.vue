...
import AddPurchase from '/@/views/HR/View/PracticalBase/Credit/AllCredit/AddPurchaseCopy.vue'
import Communicate from '/@/views/HR/View/PracticalBase/Credit/AllCredit/CommunicateCopy.vue'
import CompeteList from '/@/views/HR/View/PracticalBase/Credit/AllCredit/CompeteListCopy.vue'
import AddPayment from '/@/views/HR/View/PracticalBase/Credit/AllCredit/AddPaymentCopy.vue'

import PurchaseList from '/@/views/HR/View/PracticalBase/Credit/AllCredit/PurchaseListCopy.vue'
import PaymentList from '/@/views/HR/View/PracticalBase/Credit/AllCredit/PaymentListCopy.vue'
import IntelligenceLog from '/@/views/HR/View/PracticalBase/Credit/AllCredit/IntelligenceLog.vue'
