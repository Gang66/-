          ...
          <el-form ref="formRef" :model="data.form" :rules="rules" :inline="true">
            <div class="p-2">
              <el-form-item label="联系人" prop="CustomerConId">
                <el-select v-if="conviewType == 1" :disabled="conviewType == 5 || conviewType == 3" v-model="data.form.CustomerConId" @change="changeCusCon" placeholder="请选择" class="inputclass">
                  ...
                  <div class="flex justify-between">
                    <div>
                      <div class="flex pt-2 pl-4">
                        <div v-for="(item, i) in Problems" :key="i" @click="checkProblemsEvent(item)" class="headerbut cursor-pointer" :style="checkProblems.findIndex((x) => x.Id == item.Id) > -1 ? 'background: #027AFF;' : ''">
                          {{ i + 1 }}
                        </div>
                      </div>
                    </div>
            ...
            <div class="p-2">
              ...
              <div v-if="conviewType == 3 || conviewType == 5">
                ...
                <div v-if="conviewType == 3 || conviewType == 5" class="text-center pt-6">
                  ...
                  <el-button type="primary" @click="submitentitie()"> 提交 </el-button>
                </div>
              </div>
            </div>
          </el-card>
...
import { GetCusCommunicateInfo, GetCusCommunicateList, GetSituationInfoList, GetUpdateCommunicateState, PostAddCustomerCommunicate, PostAddCusCommunicateEntity } from '/@/api/hr/School/PracticalBase'
