<template>
  <div>
    <div :box-style="mesboxStyle" title="采购原则历史记录" :is-show="true" @closeWindow="closeWindow">
    ...
    <AddPayment v-if="data.show.view" :title="data.show.title" :ViewType="data.show.viewtype" :DataId="data.show.DataId" @closeWindow="closeshow" />
  </div>
</template>
<script lang="ts" setup>
import { GetPaymentList } from '/@/api/hr/School/PracticalBase'
