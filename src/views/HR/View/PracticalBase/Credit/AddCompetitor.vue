            ...
            <el-card class="sale_card mt-2 tablecard">
              ...
              <div>
                <el-form-item label="公司名称" prop="Company">
                  <el-input v-model="data.form.Company" :readonly="data.disabled" placeholder="请输入" style="width: 353px; height: 32px" />
                </el-form-item>
                ...
                <el-form-item label="公司地址" prop="Address">
                  <el-input v-model="data.form.Address" placeholder="请输入" style="width: 564px" />
                </el-form-item>
              </div>
            </el-card>
          </el-form>
...
import { PostEditCompetitor } from '/@/api/hr/School/PracticalBase'
...
const emit = defineEmits(['closeWindow', 'addCompetitor'])
