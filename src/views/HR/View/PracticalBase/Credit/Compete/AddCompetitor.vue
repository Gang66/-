                ...
                <div class="card-header">
                  ...
                  <div class="header-right justify-end">
                    <div class="flex justify-end">
                      <div v-if="ViewType != 1" class="pr-2">添加时间：{{ (data.form.CreateOn || '').substring(0, 11) }}</div>
                    </div>
                  </div>
                </div>
              </template>
...
import { PostEditCompetitor, PostAddCompete, GetCompeteInfo } from '/@/api/hr/School/PracticalBase'
