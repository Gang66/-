<template>
  <div class="bf-content Wages">
    ...
    <div class="bf-center-content">
      ...
      <WageSettingIndex v-if="data.selectIndex == 0"></WageSettingIndex>
...
import WageSettingIndex from './_Components/WageSettingIndex.vue'
