...
const calendar = {
    ...
    festival: [
        {value:'1-1', title: '元旦节' },
        {value:'2-14', title: '情人节' },
        {value:'5-1', title: '劳动节' },
        {value:'5-4', title: '青年节' },
        {value:'6-1', title: '儿童节' },
        {value:'9-10', title: '教师节' },
        {value:'10-1', title: '国庆节' },
        {value:'12-25', title: '圣诞节' },

        {value:'3-8', title: '妇女节' },
        {value:'3-12', title: '植树节' },
        {value:'4-1', title: '愚人节' },
        {value:'5-12', title: '护士节' },
        {value:'7-1', title: '建党节' },
        {value:'8-1', title: '建军节' },
        {value:'12-24', title: '平安夜' }
    ],
     ...
     */
    lFestival: [
        {value:'12-30', title: '除夕' },
        {value:'1-1', title: '春节' },
        {value:'1-15', title: '元宵节' },
        {value:'2-2', title: '龙抬头' },
        {value:'5-5', title: '端午节' },
        {value:'7-7', title: '七夕节' },
        {value:'7-15', title: '中元节' },
        {value:'8-15', title: '中秋节' },
        {value:'9-9', title: '重阳节' },
        {value:'10-1', title: '寒衣节' },
        {value:'10-15', title: '下元节' },
        {value:'12-8', title: '腊八节' },
        {value:'12-23', title: '北方小年' },
        {value:'12-24', title: '南方小年' }
    ],
	
	/**
	 * 返回阳历节日名称
	 */
	getFestivalKeyToTitle(key:string):string {
	    const obj = this.festival.find(x=>{return x.value==key})
		if(obj)
			return obj.title
		else
			return ''
	 ...
	 * 返回阴历节日名称
	 */
	getlFestivalKeyToTitle(key:string):string {
	    const obj = this.lFestival.find(x=>{return x.value==key})
		if(obj)
			return obj.title
		else
			return ''
     ...
     */
    solar2lunar: function(yPara:string, mPara:string, dPara:string):ICalendarDto {
        let y = parseInt(yPara)
        let m = parseInt(mPara)
        let d = parseInt(dPara)
        // 年份限定、上限
        if (y < 1900 || y > 2100) {
            return <ICalendarDto>{} // undefined转换为数字变为NaN
        }
        // 公历传参最下限
        if (y === 1900 && m === 1 && d < 31) {
            return <ICalendarDto>{}
        ...
        return {
            date: solarDate,
            lunarDate: lunarDate,
            festival: this.getFestivalKeyToTitle(festivalDate),
            lunarFestival: this.getlFestivalKeyToTitle(lunarFestivalDate),
            lYear: year,
            lMonth: month,
            lDay: day,
     ...
     * @param yPara  lunar year
     * @param mPara  lunar month
     * @param dPara  lunar day
     * @param isLeapMonth  lunar month is leap or not.[如果是农历闰月第四个参数赋值true即可]
     * @return JSON object
     * @eg:console.log(calendar.lunar2solar(1987,9,10));
     */
    lunar2solar: function(yPara:string, mPara:string, dPara:string, isLeapMonth:boolean):ICalendarDto {
        let y = parseInt(yPara)
        let m = parseInt(mPara)
        let d = parseInt(dPara)
        ...
        return this.solar2lunar(cY.toString(), cM.toString(), cD.toString())
    }
}
...
如阳历转阴历
*/
const solar2lunar = (yPara:string, mPara:string, dPara:string):ICalendarDto => {
    return calendar.solar2lunar(yPara,mPara,dPara)
}
...
interface ICalendarFestivalDto{
	title:string
	value:string
}
